	...
	<nav>
		...
		<div class="site-nav">
			...
			<a
				...
				href="projects"
				class="a-icon-projects"
			>
				<Icon name="grid" size="36" color="#fff" />
			</a>
			<a
				aria-label="uses"
				aria-current={$page.url.pathname === '/uses' ? 'page' : undefined}
				href="uses"
				class="a-icon-uses"
			>
		...
		<div class="resume">
			<a
				href="https://www.notion.so/Brian-J-Casey-22e9e5e1522e48a0b09d4c9efa588c40"
