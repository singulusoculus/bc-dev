<script context="module">
	...
	export const load = async () => {
		const reMd = await getMarkdownContents('rankingengine')
		const tnMd = await getMarkdownContents('topnine')
		const pmMd = await getMarkdownContents('pubmeeple')
		const bcMd = await getMarkdownContents('briancasey')
